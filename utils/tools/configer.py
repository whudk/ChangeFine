...
class _ConditionHelper:
    ...
    @property
    def pred_dt_obj_chg(self):
        return self.configer.exists('data', 'pred_dt_obj_chg')
    @property
    def pred_dt_offset(self):
        return self.configer.exists('data', 'pred_dt_offset')
    @property
    def pred_dt_offset_chg(self):
        return self.configer.exists('data', 'pred_dt_offset_chg')
    @property
    def use_dt_chg(self):
        return self.configer.exists('data', 'use_dt_chg')
    @property
    ...
    @property
    def use_dt_offset_chg(self):
        return self.configer.exists('data', 'use_dt_offset_chg')
    @property
